...
class Counter extends Component {
  ...
  incrementIfOdd = () => {
    ...
    this.props.count % 2 !== 0 ? this.props.incrementOdd() : state;
...
const mapStateToProps = (state) => {
  // Recibe el estado global del store
  return {
    count: state.count,
  };
};
...
export default connect(mapStateToProps, { increment, decrement, incrementOdd })(
  Counter
);
